...
class RekapSiswa extends StatelessWidget {
  const RekapSiswa({Key? key, required this.mapelData}) : super(key: key);
  final MataPelajaranData mapelData;

  @override
  Widget build(BuildContext context) {
    final rekapC = Get.put(RekapAbsenController(mapelData.id!.toString()));
      ...
      body: Center(
        child: Column(
          children: [
            ...
            Center(
              child: Text(
                "Mata Pelajaran: ${mapelData.namaMapel}",
                style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
                ),
